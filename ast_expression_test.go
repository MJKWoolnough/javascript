...
func TestAssignmentExpression(t *testing.T) {
	doTests(t, []sourceFn{
		...
		{"a >>>= 1", func(t *test, tk Tokens) { // 29
			lit1 := makeConditionLiteral(tk, 7)
			t.Output = AssignmentExpression{
				LeftHandSideExpression: &LeftHandSideExpression{
					NewExpression: &NewExpression{
						MemberExpression: MemberExpression{
		...
		{"{a: {b}} = c", func(t *test, tk Tokens) { // 48
			t.Output = AssignmentExpression{
				AssignmentPattern: &AssignmentPattern{
					ObjectAssignmentPattern: &ObjectAssignmentPattern{
						AssignmentPropertyList: []AssignmentProperty{
		...
		{"{a: {b} = c} = d", func(t *test, tk Tokens) { // 52
			t.Output = AssignmentExpression{
				AssignmentPattern: &AssignmentPattern{
					ObjectAssignmentPattern: &ObjectAssignmentPattern{
						AssignmentPropertyList: []AssignmentProperty{
		...
		{"{a: {b: !c}} = d", func(t *test, tk Tokens) { // 53
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{"{a(){}} = b", func(t *test, tk Tokens) { // 55
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
							Err:     ErrInvalidAssignmentProperty,
							Parsing: "AssignmentProperty",
							Token:   tk[1],
						},
						Parsing: "ObjectAssignmentPattern",
		...
		{"[...a=1] = c", func(t *test, tk Tokens) { // 58
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err:     ErrInvalidAssignment,
		...
		{"[a /= b] = c", func(t *test, tk Tokens) { // 61
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
			...
			t.Output = AssignmentExpression{
				AssignmentPattern: &AssignmentPattern{
					ArrayAssignmentPattern: &ArrayAssignmentPattern{
									...
									LeftHandSideExpression: &LeftHandSideExpression{
										NewExpression: &NewExpression{
											MemberExpression: MemberExpression{
												...
												IdentifierName: &tk[8],
												Comments:       [5]Comments{nil, nil, nil, nil, {&tk[10]}},
												Tokens:         tk[4:11],
											},
											Tokens: tk[4:11],
										},
						...
						Comments: [3]Comments{{&tk[2]}, nil, {&tk[22]}},
						Tokens:   tk[:25],
					},
					Tokens: tk[:25],
				},
			...
			t.Output = AssignmentExpression{
				AssignmentPattern: &AssignmentPattern{
					ArrayAssignmentPattern: &ArrayAssignmentPattern{
						...
						Comments: [3]Comments{{&tk[2]}, {&tk[4]}, {&tk[14]}},
						Tokens:   tk[:17],
					},
					Tokens: tk[:17],
				},
			...
			t.Output = AssignmentExpression{
				AssignmentPattern: &AssignmentPattern{
					ObjectAssignmentPattern: &ObjectAssignmentPattern{
						...
						Comments: [3]Comments{{&tk[2]}, nil, {&tk[10]}},
						Tokens:   tk[:13],
					},
					Tokens: tk[:13],
				},
