...
func TestArrowFunction(t *testing.T) {
	doTests(t, []sourceFn{
		...
		{"({...a.b} = {}) => 1", func(t *test, tk Tokens) { // 44
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{"({a: [b.c]} = {}) => 1", func(t *test, tk Tokens) { // 46
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{"({a: {b: c.d}} = {}) => 1", func(t *test, tk Tokens) { // 48
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{"([[a.b] = []] = []) => 1", func(t *test, tk Tokens) { // 51
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{"([...a, ...b]) => 1", func(t *test, tk Tokens) { // 55
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
