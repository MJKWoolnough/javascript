...
func TestScriptScope(t *testing.T) {
	for n, test := range [...]struct {
		...
		{ // 88
			...
			func(s *javascript.Script) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(s.StatementList[0].Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.JSXElement).Children[0].JSXChildExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(s.StatementList[0].Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.JSXElement).Children[0].JSXChildExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		{ // 89
			...
			func(s *javascript.Script) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(s.StatementList[0].Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.JSXFragment).Children[0].JSXChildExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(s.StatementList[0].Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.JSXFragment).Children[0].JSXChildExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		{ // 90
			...
			func(s *javascript.Script) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(s.StatementList[0].Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.JSXElement).Attributes[0].AssignmentExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(s.StatementList[0].Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.JSXElement).Attributes[0].AssignmentExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		{ // 91
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(s.StatementList[0].Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.JSXElement).ElementName.Identifier,
					},
				}
				scope.Bindings["d"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.UnwrapConditional(s.StatementList[0].Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.JSXElement).Attributes[1].AssignmentExpression.ConditionalExpression).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
...
func TestModuleScope(t *testing.T) {
	for n, test := range [...]struct {
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalORExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(&m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalANDExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 124
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.WrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalORExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.WrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalORExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalANDExpression.LogicalANDExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(&m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalANDExpression.BitwiseORExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 131
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.WrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalANDExpression.LogicalANDExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.WrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalANDExpression.LogicalANDExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalANDExpression.BitwiseORExpression.BitwiseORExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(&m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalANDExpression.BitwiseORExpression.BitwiseXORExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 133
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.WrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalANDExpression.BitwiseORExpression.BitwiseORExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.WrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression.LogicalORExpression.LogicalANDExpression.BitwiseORExpression.BitwiseORExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		{ // 134
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.OptionalExpression).OptionalChain.OptionalChain.Expression.Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.OptionalExpression).OptionalChain.OptionalChain.Expression.Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.OptionalExpression).MemberExpression.PrimaryExpression.IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.OptionalExpression).OptionalChain.Arguments.ArgumentList[0].AssignmentExpression.ConditionalExpression).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 136
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.OptionalExpression).OptionalChain.Arguments.ArgumentList[0].AssignmentExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.OptionalExpression).OptionalChain.Arguments.ArgumentList[0].AssignmentExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.OptionalExpression).OptionalChain.TemplateLiteral.Expressions[0].Expressions[0].ConditionalExpression).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 138
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.OptionalExpression).OptionalChain.TemplateLiteral.Expressions[0].Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.OptionalExpression).OptionalChain.TemplateLiteral.Expressions[0].Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		{ // 139
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ArrayLiteral).ElementList[0].AssignmentExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ArrayLiteral).ElementList[0].AssignmentExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		{ // 140
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.ObjectLiteral).PropertyDefinitionList[0].AssignmentExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.ObjectLiteral).PropertyDefinitionList[0].AssignmentExpression.ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		{ // 141
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.FunctionDeclaration).FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.FunctionDeclaration).FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		{ // 142
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.ClassDeclaration).ClassBody[0].MethodDefinition.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.ClassDeclaration).ClassBody[0].MethodDefinition.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.TemplateLiteral).Expressions[0].Expressions[0].ConditionalExpression).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.TemplateLiteral).Expressions[1].Expressions[0].ConditionalExpression).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 144
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.TemplateLiteral).Expressions[0].Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.TemplateLiteral).Expressions[0].Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.BitwiseXORExpression).BitwiseXORExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.BitwiseXORExpression).BitwiseANDExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.BitwiseANDExpression).BitwiseANDExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.BitwiseANDExpression).EqualityExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 148
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.BitwiseANDExpression).BitwiseANDExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.BitwiseANDExpression).BitwiseANDExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		{ // 149
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.ObjectLiteral).PropertyDefinitionList[0].PropertyName.ComputedPropertyName.ConditionalExpression).(*javascript.MemberExpression).Expression.Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.ObjectLiteral).PropertyDefinitionList[0].PropertyName.ComputedPropertyName.ConditionalExpression).(*javascript.MemberExpression).Expression.Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		{ // 150
			...
			func(m *javascript.Module) (*Scope, error) {
				scope := NewScope()
				mscope := scope.newFunctionScope(javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.ObjectLiteral).PropertyDefinitionList[0].MethodDefinition)
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       mscope,
						Token:       javascript.UnwrapConditional(javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.ObjectLiteral).PropertyDefinitionList[0].MethodDefinition.FunctionBody.StatementList[0].Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 151
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.ObjectLiteral).PropertyDefinitionList[0].MethodDefinition.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ParenthesizedExpression).Expressions[0].ConditionalExpression).(*javascript.ObjectLiteral).PropertyDefinitionList[0].MethodDefinition.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.EqualityExpression).EqualityExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.EqualityExpression).RelationalExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 153
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.EqualityExpression).EqualityExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.EqualityExpression).EqualityExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.RelationalExpression).RelationalExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.RelationalExpression).ShiftExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 155
			"(() => {let a,a}) instanceof b",
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.RelationalExpression).RelationalExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.RelationalExpression).RelationalExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ShiftExpression).ShiftExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ShiftExpression).AdditiveExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 157
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ShiftExpression).ShiftExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.ShiftExpression).ShiftExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.AdditiveExpression).AdditiveExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.AdditiveExpression).MultiplicativeExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 159
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.AdditiveExpression).AdditiveExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.AdditiveExpression).AdditiveExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["b"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.MultiplicativeExpression).ExponentiationExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 161
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.MultiplicativeExpression).MultiplicativeExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.MultiplicativeExpression).MultiplicativeExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
				...
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingRef,
						Scope:       scope,
						Token:       javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.UpdateExpression).UnaryExpression)).(*javascript.PrimaryExpression).IdentifierReference,
					},
				}
		...
		{ // 165
			...
			func(m *javascript.Module) (*Scope, error) {
				return nil, ErrDuplicateDeclaration{
					Declaration: javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.UpdateExpression).UnaryExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[0].BindingIdentifier,
					Duplicate:   javascript.UnwrapConditional(javascript.WrapConditional(javascript.UnwrapConditional(m.ModuleListItems[0].StatementListItem.Statement.ExpressionStatement.Expressions[0].ConditionalExpression).(*javascript.UpdateExpression).UnaryExpression)).(*javascript.ParenthesizedExpression).Expressions[0].ArrowFunction.FunctionBody.StatementList[0].Declaration.LexicalDeclaration.BindingList[1].BindingIdentifier,
				}
			},
		},
		...
		{ // 167
			...
			func(m *javascript.Module) (*Scope, error) {
				scope := NewScope()
				fscope := scope.newFunctionScope(m.ModuleListItems[0].StatementListItem.Declaration.FunctionDeclaration)
				iscope := fscope.newLexicalScope(m.ModuleListItems[0].StatementListItem.Declaration.FunctionDeclaration.FunctionBody.StatementList[0].Statement.IterationStatementFor)
				iscope.newLexicalScope(m.ModuleListItems[0].StatementListItem.Declaration.FunctionDeclaration.FunctionBody.StatementList[0].Statement.IterationStatementFor.Statement.BlockStatement)
				scope.Bindings["a"] = []Binding{
					{
						BindingType: BindingHoistable,
						Scope:       scope,
				...
				fscope.Bindings["b"] = []Binding{
					...
					},
					{
						BindingType: BindingVar,
						Scope:       iscope,
						Token:       m.ModuleListItems[0].StatementListItem.Declaration.FunctionDeclaration.FunctionBody.StatementList[0].Statement.IterationStatementFor.InitVar[0].BindingIdentifier,
					},
				}
				iscope.Bindings["b"] = []Binding{
					{
						BindingType: BindingVar,
						Scope:       iscope,
						Token:       m.ModuleListItems[0].StatementListItem.Declaration.FunctionDeclaration.FunctionBody.StatementList[0].Statement.IterationStatementFor.InitVar[0].BindingIdentifier,
