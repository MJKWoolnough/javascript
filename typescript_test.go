...
func TestTypescriptModule(t *testing.T) {
	doTests(t, []sourceFn{
		...
		{`import {type a b} from './c';`, func(t *test, tk Tokens) { // 3
			t.Typescript = true
			t.Err = Error{
				Err: Error{
					Err: Error{
...
static readonly E;
		...
		{`import {type} from 'a';`, func(t *test, tk Tokens) { // 8
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`import {type A} from 'a';`, func(t *test, tk Tokens) { // 10
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`import {type as} from 'a';`, func(t *test, tk Tokens) { // 11
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`import {type as as} from 'a';`, func(t *test, tk Tokens) { // 12
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`import {type as as as} from 'a';`, func(t *test, tk Tokens) { // 13
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
...
{}`, func(t *test, tk Tokens) { // 15
		...
		{`class A<B, C> extends D<E> implements F, G<H> {}`, func(t *test, tk Tokens) { // 17
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`class A extends D<E> implements F, G<H> {}`, func(t *test, tk Tokens) { // 18
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`class A extends D implements F, G<H> {}`, func(t *test, tk Tokens) { // 19
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`class A<B, C> extends G<H> implements D, E<F> {}`, func(t *test, tk Tokens) { // 20
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`class A implements D, E<F> extends G<H> {}`, func(t *test, tk Tokens) { // 21
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
...
i <J> () {}
		...
		{`function A<B>(c: D, [e, f]?: [number, string], {g}: {g: boolean}, ...i: J): K {}`, func(t *test, tk Tokens) { // 25
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
									...
									Expressions: []AssignmentExpression{
										{
											ConditionalExpression: WrapConditional(&LeftHandSideExpression{
												...
												Comments: jsParser(tk[2:5]).toTypescript(),
												Tokens:   tk[:5],
											}),
											Tokens: tk[:5],
										},
		...
		{`1 as number`, func(t *test, tk Tokens) { // 27
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err:     ErrMissingSemiColon,
		...
		{`function a(this){}`, func(t *test, tk Tokens) { // 29
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`function a(this: T){}`, func(t *test, tk Tokens) { // 31
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`function a(this, b){}`, func(t *test, tk Tokens) { // 33
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`<A>(a: A, b: C): D => {}`, func(t *test, tk Tokens) { // 37
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`async (): A => {}`, func(t *test, tk Tokens) { // 39
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`async (a: T) => {}`, func(t *test, tk Tokens) { // 40
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`async <A>(a: A, b: C): D => {}`, func(t *test, tk Tokens) { // 41
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
									...
									BindingList: []LexicalBinding{
										{
											...
											Initializer: &AssignmentExpression{
												ConditionalExpression: WrapConditional(&LeftHandSideExpression{
													...
													Comments: jsParser(tk[11:14]).toTypescript(),
													Tokens:   tk[9:14],
												}),
												Tokens: tk[9:14],
											},
										...
										},
										{
											...
											Initializer: &AssignmentExpression{
												ConditionalExpression: WrapConditional(&LeftHandSideExpression{
													...
													Comments: jsParser(tk[24:27]).toTypescript(),
													Tokens:   tk[22:27],
												}),
												Tokens: tk[22:27],
											},
		...
		{"let a: B = c as D, [e] = f as const", func(t *test, tk Tokens) { // 43
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`const a = B<C, D>()`, func(t *test, tk Tokens) { // 45
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
									...
									BindingList: []LexicalBinding{
										{
											...
											Initializer: &AssignmentExpression{
												ConditionalExpression: WrapConditional(&CallExpression{
													...
													Comments: [5]Comments{nil, jsParser(tk[7:13]).toTypescript()},
													Tokens:   tk[6:15],
												}),
												Tokens: tk[6:15],
											},
		...
		{`const a = new B<C, D>()`, func(t *test, tk Tokens) { // 46
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
												...
												ConditionalExpression: WrapConditional(&NewExpression{
													MemberExpression: MemberExpression{
														MemberExpression: &MemberExpression{
															...
															Comments: [5]Comments{nil, nil, nil, nil, jsParser(tk[9:15]).toTypescript()},
															Tokens:   tk[8:15],
														},
														Arguments: &Arguments{
															Tokens: tk[15:17],
		...
		{`const a = new B<C<D, E>>()`, func(t *test, tk Tokens) { // 47
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
												...
												ConditionalExpression: WrapConditional(&NewExpression{
													MemberExpression: MemberExpression{
														MemberExpression: &MemberExpression{
															...
															Comments: [5]Comments{nil, nil, nil, nil, jsParser(tk[9:18]).toTypescript()},
															Tokens:   tk[8:18],
														},
														Arguments: &Arguments{
															Tokens: tk[18:20],
		...
		{`const a = (b): b is C => {}`, func(t *test, tk Tokens) { // 48
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
									...
									Expressions: []AssignmentExpression{
										{
											ConditionalExpression: WrapConditional(&MemberExpression{
												...
												IdentifierName: &tk[3],
												Comments:       [5]Comments{nil, nil, nil, nil, {&tk[4]}},
												Tokens:         tk[:5],
											}),
											Tokens: tk[:5],
										},
		...
		{`a[0]!.b`, func(t *test, tk Tokens) { // 53
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`a[0]!().b`, func(t *test, tk Tokens) { // 58
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`type A = {[B]: any}`, func(t *test, tk Tokens) { // 59
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`class A {#B: string}`, func(t *test, tk Tokens) { // 60
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`abstract class A {}`, func(t *test, tk Tokens) { // 61
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`export default abstract class A {}`, func(t *test, tk Tokens) { // 62
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
...
function a() {}`, func(t *test, tk Tokens) { // 106
		...
		{`export function a(): b;
export function a(): c;
export function a() {}`, func(t *test, tk Tokens) { // 107
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
						ExportDeclaration: &ExportDeclaration{
							Declaration: &Declaration{
								FunctionDeclaration: &FunctionDeclaration{
									...
									Comments: [5]Comments{nil, nil, nil, jsParser(tk[5:29]).toTypescript()},
									Tokens:   tk[2:34],
								},
								Tokens: tk[2:34],
							},
...
export default function() {}`, func(t *test, tk Tokens) { // 108
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
	...
	[e]!
		...
		{`a as any as b as c`, func(t *test, tk Tokens) { // 111
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
									...
									Expressions: []AssignmentExpression{
										{
											ConditionalExpression: &ConditionalExpression{
												LogicalORExpression: WrapConditional(&LeftHandSideExpression{
													...
													Comments: jsParser(tk[2:13]).toTypescript(),
													Tokens:   tk[:13],
												}).LogicalORExpression,
		...
		{`const a = (b :c) => {}`, func(t *test, tk Tokens) { // 112
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`const a = b?.c()!;`, func(t *test, tk Tokens) { // 113
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`type A = {[B in C]: D;}`, func(t *test, tk Tokens) { // 114
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`function a<const B extends C[]>(d: B) {}`, func(t *test, tk Tokens) { // 115
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`type A<B> = { B(): C; finally(): B; }`, func(t *test, tk Tokens) { // 116
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`((): this is b => true)`, func(t *test, tk Tokens) { // 117
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`class A {b(): a is b {}}`, func(t *test, tk Tokens) { // 118
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`type A<B extends any[]> = B extends [b: infer C] ? C : B;`, func(t *test, tk Tokens) { // 119
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`class A extends B<C<D>> {}`, func(t *test, tk Tokens) { // 120
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`const a: import("mod").A = 1`, func(t *test, tk Tokens) { // 121
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`type A = [B?];`, func(t *test, tk Tokens) { // 122
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`a.method().method2<string>()`, func(t *test, tk Tokens) { // 123
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
									...
									Expressions: []AssignmentExpression{
										{
											ConditionalExpression: WrapConditional(&CallExpression{
												...
												Comments: [5]Comments{nil, jsParser(tk[7:10]).toTypescript()},
												Tokens:   tk[:12],
											}),
											Tokens: tk[:12],
										},
		...
		{`a?.<string>()`, func(t *test, tk Tokens) { // 124
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`a?.method<string>()`, func(t *test, tk Tokens) { // 125
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
		...
		{`const a = b as c ?? d`, func(t *test, tk Tokens) { // 126
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
													...
													CoalesceExpression: &CoalesceExpression{
														CoalesceExpressionHead: &CoalesceExpression{
															BitwiseORExpression: WrapConditional(&LeftHandSideExpression{
																...
																Comments: jsParser(tk[8:11]).toTypescript(),
																Tokens:   tk[6:11],
		...
		{`a?.b!.c`, func(t *test, tk Tokens) { // 127
			t.Typescript = true
			t.Output = Module{
				ModuleListItems: []ModuleItem{
					{
