	...
	for n, test := range [...]struct {
		...
		{ // 144
			...
			Output: []parser.Token{
				...
				{Type: TokenJSXIdentifier, Data: "b"},
				{Type: TokenPunctuator, Data: "="},
				{Type: TokenJSXString, Data: "\"c\""},
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: TokenJSXText, Data: "text"},
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenPunctuator, Data: "/"},
				{Type: TokenJSXIdentifier, Data: "a"},
				{Type: TokenJSXElementEnd, Data: ">"},
		...
		{ // 146
			...
			Output: []parser.Token{
				...
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenJSXIdentifier, Data: "child"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenPunctuator, Data: "/"},
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: TokenJSXElementStart, Data: "<"},
		...
		{ // 159
			...
			Output: []parser.Token{
				...
				{Type: TokenPunctuator, Data: ","},
				{Type: TokenPunctuator, Data: ">"},
				{Type: TokenSingleLineComment, Data: "// abc"},
				{Type: TokenLineTerminator, Data: "\n"},
				{Type: TokenPunctuator, Data: "("},
				{Type: TokenPunctuator, Data: ")"},
				{Type: TokenWhitespace, Data: " "},
		...
		{ // 162
			...
			Output: []parser.Token{
				...
				{Type: TokenPunctuator, Data: "!"},
				{Type: TokenPunctuator, Data: ">"},
				{Type: TokenSingleLineComment, Data: "// </a>"},
				{Type: TokenLineTerminator, Data: "\n"},
				{Type: TokenPunctuator, Data: "("},
				{Type: TokenPunctuator, Data: ")"},
				{Type: TokenWhitespace, Data: " "},
		...
		{ // 163
			...
			Output: []parser.Token{
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenJSXIdentifier, Data: "abc"},
				{Type: TokenPunctuator, Data: "."},
				{Type: TokenJSXIdentifier, Data: "def"},
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: TokenJSXText, Data: "// "},
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenPunctuator, Data: "/"},
		...
		{ // 164
			...
			Output: []parser.Token{
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenJSXIdentifier, Data: "abc-def"},
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: TokenJSXText, Data: "// "},
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenPunctuator, Data: "/"},
		...
		{ // 168
			...
			Output: []parser.Token{
				...
				{Type: TokenIdentifier, Data: "abc"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenKeyword, Data: "extends"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenIdentifier, Data: "def"},
				{Type: TokenPunctuator, Data: ">"},
				{Type: TokenSingleLineComment, Data: "// </abc>"},
		...
		{ // 169
			...
			Output: []parser.Token{
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenJSXIdentifier, Data: "abc"},
				{Type: TokenMultiLineComment, Data: "/*def*/"},
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: TokenJSXText, Data: "// "},
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenPunctuator, Data: "/"},
		...
		{ // 170
			...
			Output: []parser.Token{
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenJSXIdentifier, Data: "abc"},
				{Type: TokenSingleLineComment, Data: "// def"},
				{Type: TokenLineTerminator, Data: "\n"},
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: TokenJSXText, Data: "// "},
				{Type: TokenJSXElementStart, Data: "<"},
		...
		{ // 175
			...
			Output: []parser.Token{
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenJSXIdentifier, Data: "const"},
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenPunctuator, Data: "/"},
				{Type: TokenJSXIdentifier, Data: "const"},
		...
		{ // 182
			...
			Output: []parser.Token{
				...
				{Type: TokenJSXIdentifier, Data: "Foo"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenSingleLineComment, Data: "// B"},
				{Type: TokenLineTerminator, Data: "\n"},
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenMultiLineComment, Data: "/* C */"},
				{Type: TokenMultiLineComment, Data: "/*D*/"},
				{Type: TokenPunctuator, Data: "/"},
				{Type: TokenJSXIdentifier, Data: "Foo"},
				{Type: TokenMultiLineComment, Data: "/*E*/"},
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: parser.TokenDone, Data: ""},
			},
			TS:  true,
		...
		{ // 183
			...
			Output: []parser.Token{
				{Type: TokenJSXElementStart, Data: "<"},
				{Type: TokenJSXIdentifier, Data: "Foo"},
				{Type: TokenMultiLineComment, Data: "/*A*/"},
				{Type: TokenPunctuator, Data: "/"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenMultiLineComment, Data: "/*B*/"},
				{Type: TokenJSXElementEnd, Data: ">"},
				{Type: parser.TokenDone, Data: ""},
			},
			TS:  true,
