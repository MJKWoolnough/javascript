...
func TestWalk(t *testing.T) {
	for n, test := range [...]struct {
		...
		{ // 244
			"function a() {}",
			func(m *javascript.Module) javascript.Type {
				return &m.ModuleListItems[0].StatementListItem.Declaration.FunctionDeclaration.FormalParameters
			},
			[]string{"Module", "ModuleItem", "StatementListItem", "Declaration", "FunctionDeclaration", "FormalParameters"},
		},
		{ // 245
			"function a() {}",
			func(m *javascript.Module) javascript.Type {
				return &m.ModuleListItems[0].StatementListItem.Declaration.FunctionDeclaration.FunctionBody
			},
		...
		{ // 251
			"let a, b",
			func(m *javascript.Module) javascript.Type {
				return &m.ModuleListItems[0].StatementListItem.Declaration.LexicalDeclaration.BindingList[0]
			},
		...
		{ // 252
			"let a, b",
			func(m *javascript.Module) javascript.Type {
				return &m.ModuleListItems[0].StatementListItem.Declaration.LexicalDeclaration.BindingList[1]
			},
			[]string{"Module", "ModuleItem", "StatementListItem", "Declaration", "LexicalDeclaration", "LexicalBinding"},
		},
	} {
